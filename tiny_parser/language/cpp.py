...
cpp_grammar = {
    ...
    "23.2": Rule( None , "24." ),
    "24.1": Rule( Literal , (StandardToken.NUMBER, ("value", "value")) ),
    "24.2": Rule( Literal , (StandardToken.STRING, ("value", "value")) ),
    "24.3": Rule( Identifier , (StandardToken.IDENTIFIER, ("name", "value")) ),
}
